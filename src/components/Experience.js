...
const Experience = (props) => {
    ...
    return (
        <div ref={componentRef}  className="reveal" id="experience">
            ...
            <div>
                <ul>
                    <li>Gained experience using Angular and TypeScript by building new features on an admin dashboard.</li>
                    <li>Experience with microservice architecture building bespoke JSON based APIs that was incorporated within a network of other APIs.</li>
                    <li>Contributed to Android / OS front-end application development using React Native</li>
                </ul>
            </div>
        </div>
    )
