...
const Header = (props) => {
    ...
    //         <nav>
    //             <ul>
    //                 <li onClick={() => scrollFunction("about")}>About</li>
    //                 <li onClick={() => scrollFunction("experience")}>Experience</li>
    //                 <li onClick={() => scrollFunction("portfolio")}>Work</li>
    //                 <li onClick={() => scrollFunction("contact")}>Contact</li>
